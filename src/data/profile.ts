export const profile = {
  ...
  socials: [
    { label: 'GitHub', href: 'https://github.com/anishsarkars' },
    { label: 'Twitter', href: 'https://twitter.com/anishsarkars' },
    { label: 'LinkedIn', href: 'https://linkedin.com/in/anishsarkar-' },
    { label: 'Instagram', href: 'https://instagram.com/anish.sarkars' },
  ],
};
